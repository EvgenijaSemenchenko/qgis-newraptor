...
/***************************************************************************
 NewRaptor
                                 A QGIS plugin
 Add a new raptor, create buffer and impact table
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2024-05-24
        git sha              : $Format:%H$
        copyright            : (C) 2024 by DHS
        email                : semka11225@gmail.com
 ***************************************************************************/
...
class NewRaptor:
    ...
    def run(self):
        ...
        if result:
            ...
            QMessageBox.information(self.dlg, "Message", "New Nest ID: {}\n\nLatitude: {}\nSpecies: {}\nBuffer: {}\nStatus: {}n\ast Survey: {}".format(valNestID, valLat, valLng, valSpecies, valBuffer, valStatus, valLast))
